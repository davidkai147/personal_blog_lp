    ...
    <div class="about__container container grid">
      ...
      <div class="about__data">
        <p class="about__description">
          A software engineer with a customer satisfaction mindset. High level
          experience in developing web and mobile application. My passion for
        ...
        <div class="about__info">
          ...
          <div>
            ...
            <span class="about__info-name">Customers</span>
          </div>
        </div>
